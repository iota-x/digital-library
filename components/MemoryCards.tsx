      ...
      <div style={{
        ...
        {MEMORIES.map((m, i) => (
          ...
          >
            ...
            <p style={{ fontFamily:"var(--font-caveat)", fontSize:"1.05rem", lineHeight:1.55, flex:1, color:m.dark?"#ffe0ec":"var(--muted)" }}>
          ...
          >
            <motion.div
              style={{
                ...
                width:"100%",
                position:"relative",
                boxShadow:"0 24px 60px rgba(236,72,153,.25)",
              }}
